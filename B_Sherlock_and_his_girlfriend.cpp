...
Timestamp: 2026-06-03 06:08:18 IST
*/
#include <bits/stdc++.h>
using namespace std;
/* clang-format off */
...
/*
 * OBS:
 * etc->anything above n*logn would give TLE
 * prices are increasing
 * range -> [2...n+1]
 * we can use sieve to find the number of primes in the range
 * all primes can get the same color
 * all composite numbers can get the same color
 * k can be either 1 or 2
 * APR:
 * color all primes with 1 and all composite numbers with 2
 * use sieve to find the number of primes in the range and print the answer
 */
void solve(){
    ll n;cin>>n;
    vll p=sieve(n+1);
