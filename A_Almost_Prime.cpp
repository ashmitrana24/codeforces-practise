...
Timestamp: 2026-06-01 09:04:25 IST
*/
#include <bits/stdc++.h>
using namespace std;
/* clang-format off */
...
/*
 * OBS:
 * almost prime -> 2 prime factors(strict)
 * 
 * APR:
 * a very brute force ? naive -> go from 1 to n and keep checking the cnt of almost prime numbers
 */
