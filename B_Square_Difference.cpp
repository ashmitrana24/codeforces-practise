...
Timestamp: 2026-06-01 10:06:24 IST
*/
#include <bits/stdc++.h>
using namespace std;
/* clang-format off */
...
/*
 * OBS:
 * constraints are tight , have to use maths
 * APR:
 * if product to 2 numbers is prime , then one of them is exactly 1
 * 
 * a^2 - b^2 = a+b * a-b -> so a-b=1 and a+b= some prime number
 * so we use Trial division method to check if a+b is prime or not coz sieve we have to 
 * create a 2*10^11 size array which is not possible
 */
void solve(){
    ll a,b;cin>>a>>b;
    if(a-b!=1){
